...
const ProductHome: React.FC = () => {
  ...
  return (
    <div className="bg-[#fcf8f1] relative w-full py-12 sm:py-16 lg:py-20 px-4 sm:px-8 md:px-16 lg:px-[120px] 2xl:px-[200px]">
      ...
      {/* Products Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 xl:gap-8 max-w-7xl mx-auto relative">
        ...
        <button className="hidden xl:block absolute -right-16 top-1/2 -translate-y-1/2 bg-black p-[10px] rounded-[154px] hover:bg-[#ffb546] transition-all duration-300 z-10">
